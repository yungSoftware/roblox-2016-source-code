...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.7.18 2010-05-10 00:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.7.18 2010-05-10 00:00:00 GMT")
#endif
  ...
  { for (;;)
    { register soap_wchar c;
      ...
      *t = '\0';
      ...
      if (soap->bufidx + soap->chunksize <= soap->bufidx)
      { soap->chunkbuflen = 0;
