# Microsoft Developer Studio Project File - Name="wwwmux" - Package Owner=<4>
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib WSock32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\..\..\Bin\Release\wwwmux.dll"
...
# PROP Output_Dir "..\..\..\Bin"
# PROP Intermediate_Dir ".\wwwmux\Debug"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ".\wwwmux"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib WSock32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\..\..\Bin\Debug\wwwmux.dll"
