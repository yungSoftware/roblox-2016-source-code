...
ALL : "wwwinit - Win32 Release" "$(OUTDIR)\trace.exe"
...
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "..\..\..\src" /I "..\..\..\External" /I "..\..\..\..\modules\expat\xmlparse" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "WWW_WIN_ASYNC" /Fp"$(INTDIR)\trace.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\trace.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\trace.pdb" /machine:I386 /out:"$(OUTDIR)\trace.exe" 
LINK32_OBJS= \
	"$(INTDIR)\trace.obj" \
	"..\..\..\..\Bin\wwwapp.lib" \
	"..\..\..\..\Bin\wwwcore.lib" \
...
"$(OUTDIR)\trace.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "wwwinit - Win32 Debug" "$(OUTDIR)\trace.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\trace.exe"
	-@erase "$(OUTDIR)\trace.ilk"
	-@erase "$(OUTDIR)\trace.pdb"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\trace.pdb" /debug /machine:I386 /out:"$(OUTDIR)\trace.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\trace.obj" \
	"..\..\..\..\Bin\wwwapp.lib" \
	"..\..\..\..\Bin\wwwcore.lib" \
