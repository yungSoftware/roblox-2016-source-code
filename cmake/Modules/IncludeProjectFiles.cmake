...
macro( INCLUDE_PROJECT_FILES target path_globs )
  foreach(path_glob ${path_globs})
    # Convert any Windows-style backslashes to CMake-friendly forward slashes
    file(TO_CMAKE_PATH "${path_glob}" _normalized_glob)
    file(GLOB_RECURSE _hdrs "${_normalized_glob}")
