...
//					SocketLayer::SetDoNotFragment(socketToUse, 1);
	...
	int startingActiveSystemListIndex = 0;
	...
	//	remoteSystemList[ remoteSystemIndex ].allowSystemAddressAssigment=true;
			...
			bool bufferEmpty = remoteSystem->reliabilityLayer.Update(NULL, systemAddress, remoteSystem->MTUSize, timeNS, maxOutgoingBPS, pluginListNTS, &rnr, NULL, NULL, updateBitStream); // systemAddress only used for the internet simulator test
